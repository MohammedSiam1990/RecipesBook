...
export class PlacesService {
  ...
  fetchPlaces() {
    return this.http.get<{ [key: string]: PlaceData }>('https://recipesbook-fb9fb.firebaseio.com/offered-places.json')
    .pipe(map(resData => {
      console.log(resData);
      const places = [];
    ...
    return this.places.pipe(
      ...
      switchMap(places => {
        ...
        return this.http.put(
          `https://recipesbook-fb9fb.firebaseio.com/offered-places/${placeId}.json`,
